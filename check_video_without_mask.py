...
cap = cv2.VideoCapture("converted_video_06_27/18.08.00-18.16.00[A][0@0][0].mp4")
if not cap.isOpened():
...
out = cv2.VideoWriter('predict/predicted_video_5.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (frame_width, frame_height))
...
def save_to_csv(data, output_path='csv/railcar_data_5.csv'):
